...
<a href="<?= base_url('admin/send_balance_request_super_admin'); ?>" class="btn btn-primary">Send Money Request Superadmin</a>  
     ...
     <h1>Send Balance Request Super Admin</h1>
           ...
           <table  class="table table-striped">
            ...
            <tbody>
                <?php  $sr_no= 1; foreach ($list_admin_request_balance as $admin): ?>
                <tr>
                    ...
                    <td><?php if(empty($admin_users_details->current_wallet)){ echo $admin_users_details->amout_given; } elseif(!empty($admin_users_details->current_wallet)){ echo $admin          ->current_wallet_amount; } ?></td>
                </tr>    
